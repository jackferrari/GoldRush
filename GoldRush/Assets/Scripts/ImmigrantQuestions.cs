...
public class ImmigrantQuestions : AllQuestions {
    ...
    public ImmigrantQuestions()
    {
        ...
        QuestionObject q1 = new QuestionObject(decreaseGold, nothingNew, "You feel concerned about the gold you are making.", "Stay put", "Try a new area", "You decide to stay", "You find a new area that feels more promising");
